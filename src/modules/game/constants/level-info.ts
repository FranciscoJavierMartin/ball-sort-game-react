import type { ExtendedGameProps } from '@/modules/game/components/game/game';

export const level1: ExtendedGameProps = {
  size: 35,
  distribution: [2],
  capacity: 4,
  level: 1,
...
export const level30: ExtendedGameProps = {
  capacity: 4,
  distribution: [5, 4],
  isSpecialLevel: false,
  level: 30,
...
export const level31: ExtendedGameProps = {
  capacity: 4,
  distribution: [6, 6],
  isSpecialLevel: false,
  level: 31,
...
export const level32: ExtendedGameProps = {
  size: 30,
  distribution: [6, 5],
  capacity: 4,
  level: 32,
